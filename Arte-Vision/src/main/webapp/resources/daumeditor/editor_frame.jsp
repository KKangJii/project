	...
	<DIV id=tx_trex_container class=tx-editor-container>
				...
				<UL class="tx-bar tx-bar-left">
						...
						<DIV id=tx_richtextbox_menu class="tx-richtextbox-menu tx-menu">
							...
							<DIV class=tx-menu-footer>
								<IMG class=tx-menu-confirm alt=""
									src="${pageContext.request.contextPath}/resources/daumOpenEditor/images/icon/editor/btn_confirm.gif?rv=1.0.1">
								<IMG class=tx-menu-cancel hspace=3 alt=""
									src="${pageContext.request.contextPath}/resources/daumOpenEditor/images/icon/editor/btn_cancel.gif?rv=1.0.1">
							</DIV>
						</DIV>
					<LI class=tx-list>
					...
					<LI class=tx-list>
						...
						<DIV id=tx_background_menu
							...
							unselectable="on"></DIV>
					<LI class=tx-list>
						<DIV id=tx_dictionary
							class="&#9;&#9; tx-btn-rbg &#9;tx-dictionary" unselectable="on">
		...
		<DIV id=tx_canvas class=tx-canvas>
			<DIV id=tx_loading class=tx-loading>
				<DIV>
					<IMG
						src="${pageContext.request.contextPath}/resources/daumOpenEditor/images/icon/editor/loading2.png"
		...
		<DIV id=tx_resizer class=tx-resize-bar>
			...
			<IMG id=tx_resize_holder alt=""
				src="${pageContext.request.contextPath}/resources/daumOpenEditor/images/icon/editor/skin/01/btn_drag01.gif"
			...
			<DIV id=tx_attach_box class=tx-attach-box>
				<DIV class=tx-attach-box-inner>
					<DIV id=tx_attach_preview class=tx-attach-preview>
						<P>&nbsp;</P>
						<IMG
							src="${pageContext.request.contextPath}/resources/daumOpenEditor/images/icon/editor/pn_preview.gif"
