...
<div class="body">
	...
	-->
	<form name="tx_editor_form" id="tx_editor_form" action="${ pageContext.request.contextPath }/board/write" method="post"  accept-charset="utf-8" >
	<c:if test="${ listNo ne null }">
		<input type ="hidden" name = "no" value="${ listNo }">
	</c:if>
		제목 <br/>
		<input type="text" name = "title" class="form-control" style = "width : 100%;"/><br/>
		<br/>
		
		<input type="text" name = "writer" class="form-control" style = "width : 100%;" value = "${ loginVO.nickname }" readonly/> 
		<br/>
		<br/>
		<!-- 에디터 컨테이너 시작 -->
	...
	<div id="tx_attach_div" class="tx-attach-div">
		...
		<div id="tx_attach_box" class="tx-attach-box">
			<div class="tx-attach-box-inner">
				<div id="tx_attach_preview" class="tx-attach-preview"><p></p><img src="${ pageContext.request.contextPath }/resources/daumeditor/images/icon/editor/pn_preview.gif" width="147" height="108" unselectable="on"/></div>
			...
			attacher:{ 
				image:{ 
					features:{left:250,top:65,width:400,height:190,scrollbars:0}, //팝업창 사이즈
						popPageUrl:'${pageContext.request.contextPath}/board/imagePopup' //팝업창 주소 
					} 
			},
			capacity: { maximum: 5*1024*1024
			}
