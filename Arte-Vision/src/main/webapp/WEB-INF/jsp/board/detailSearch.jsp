...
<div class="table-responsive">
	<table id="board_table" class="table no-margin" style="background-color : rgb(242, 242, 242);">
		<tr>
			<th width="5%" style = "color : #000">제목</th>
			<td style = "color : #000"><c:out value="${ boardVO.title }"></c:out></td>
			<td width="10%" align="right" style = "color : #000">${boardVO.regDate}</td>
		</tr>
		<tr>
			<th width="10%" style = "color : #000">작성자</th>
		...
		<div>
			<div class="input-group" style="width:94%; float: left;">
				<input type="hidden" name="rno" value="${boardVO.no}" /> 
					<input type="text" name = "writer" id="writer44" class="form-control" value = "${ loginVO.nickname }" readonly/><br/>
					 <input type="text"
